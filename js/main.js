...
(function () {
  ...
  function switchTab(next) {
    ...
    indicator.classList.toggle("slide-right", goRight);
    ...
    const TRANSITION =
      "opacity 0.38s ease, transform 0.38s cubic-bezier(0.4,0,0.2,1)";
